...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
  ...
  Design notes:
    ...
    - Instantiated and directly defined patterns are appear after the abstract patterns, also in alphabetical order.  The id of each 
  ...
  <pattern id="TotalEfficiencyCalibrationReferenceTypeMatch" is-a="AbstractReferenceTypeMatch">
    <param name="attribute-name" value="totalEfficiencyCalibrationReference"/>
    <param name="element-name" value="TotalEfficiencyCalibration"/>
  </pattern>
